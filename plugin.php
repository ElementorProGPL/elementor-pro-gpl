...
class Plugin {
	...
	private function __construct() {
		...
		if ( is_admin() ) {
			...
			$config = array(
				...
				'api_url' => 'https://api.github.com/repos/pro-elements/pro-elements',
				'raw_url' => 'https://raw.githubusercontent.com/pro-elements/pro-elements/master',
				'github_url' => 'https://github.com/pro-elements/pro-elements',
				'zip_url' => 'https://github.com/pro-elements/pro-elements/archive/v{release_version}.zip',
				'sslverify' => true,
				'requires' => '5.0',
				'tested' => '5.4.2',
				'readme' => 'README.md',
	...
	final public static function get_title() {
		return __( 'Pro Element', 'elementor-pro' );
	}
}
